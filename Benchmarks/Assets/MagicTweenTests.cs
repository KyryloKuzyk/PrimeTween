...
public class MagicTweenTests {
    ...
    [UnityTest, Performance] public IEnumerator _01_RotationAnimation_DOTween() => DOTween_PrimeTweenTests.measureAverageFrameTimes(() => transform.TweenRotation(targetRotation, longDuration));
